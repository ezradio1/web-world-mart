...
const PriceFilterInput = (props: PriceFilterProps) => {
  ...
  return (
    <div className="min-w-[220px] text-sm relative flex items-center px-4 cursor-pointer hover:bg-gray-300 transition-all group border border-gray-400 rounded">
